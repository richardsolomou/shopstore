		...
		public function second()
		{
			...
			if (isset($_POST['first']) && DB_SETUP == false) {
		        ...
		        try {
			        ...
			        $db_conn->query('CREATE TABLE basket (basket_ID int unsigned NOT NULL auto_increment, basket_quantity int unsigned NULL default "1", product_ID int unsigned NOT NULL, customer_ID int unsigned NOT NULL, order_ID int unsigned NULL, PRIMARY KEY (basket_ID));');
