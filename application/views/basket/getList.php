                        ...
                        <tr class="centered">
                            ...
                            <td class="width25">
                                <form id="updateBasket_<?php echo $item['basket_ID']; ?>" method="post">
                                    ...
                                    <input type="text" class="smaller" id="basket_quantity" placeholder="Quantity" name="basket_quantity" onfocusout="layercms.webscrp.doEdit('basket', <?php echo $item['product_ID']; ?>, 'updateBasket_<?php echo $item['basket_ID']; ?>', 'operationAlert', null, '<?php echo BASE_PATH . '/basket/getTable/'; ?>')" required value="<?php echo $item['basket_quantity']; ?>" pattern="[0-9]+">
