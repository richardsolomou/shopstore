...
<html lang="en">
	...
	<body>
		...
		<div id="wrapper">
			...
			<?php if (isset($admin)) { ?>
			<div class="adminBar">
				<p>Welcome <?php echo $admin['admin_firstname'] . ' ' . $admin['admin_lastname']; ?><span class='pull-right'>Currently logged in as <strong><?php echo $admin['admin_username']; ?></strong>.</span></p>
				<hr class="margin1">
				<ul>
